...
public class SubarraySumsII {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < n; i++) {
            ...
            // Check if the sum of the subarray from index 0 to index i is equal x.
            if (curSum - x == 0) {
                counter++;
            }

            // Check if there is a subarray from index different of 0 to index i that equal to to x.
            if (aux.containsKey(curSum - x)) {
                counter += aux.get(curSum - x);
            }

            aux.put(curSum, aux.getOrDefault(curSum, 0L) + 1);
        }
